...
import { RazonSocial, IDireccionEnvio } from "../../types";
...
const RazonSocialList: React.FC = () => {
  ...
  useEffect(() => { fetchRazonesSociales(); }, []);
  ...
  const handleSearch = (term: string) => {
    ...
    if (!term) setFilteredRazonesSociales(razonesSociales);
      ...
      setFilteredRazonesSociales(razonesSociales.filter(rs =>
  ...
  const handleAddDireccionEnvio = () => {
    setNewRazonSocial({ ...newRazonSocial, direccionEnvio: [...newRazonSocial.direccionEnvio, { ...emptyDireccionEnvio }] });
  };
  
  const handleRemoveDireccionEnvio = (idx: number) => {
    setNewRazonSocial({ ...newRazonSocial, direccionEnvio: newRazonSocial.direccionEnvio.filter((_, i) => i !== idx) });
  };
  ...
  const columns: DataTableColumn<RazonSocial>[] = [
    ...
    { key: "direccionEnvio", label: "Direcciones de Envío", render: (rs) => (
      <ul className="mb-0 ps-3">
        {rs.direccionEnvio.map((d, i) => (
          <li key={i}>
            <b>{d.nombre}</b><br/>
            {d.direccion}
            {d.telefono && <><br/>Tel: {d.telefono}</>}
  ...
  return (
    <div className="container-fluid mt-4 px-1 px-sm-3">
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-stretch gap-2 mb-3">
        ...
        />
        <Button variant="success" onClick={() => { setShowModal(true); setEditId(null); setNewRazonSocial({ ...emptyRazonSocial }); }}>
        ...
        <DataTable
          ...
          actions={(razonSocial) => (
            <div className="d-flex flex-column flex-sm-row align-items-stretch gap-1">
              <Button variant="warning" size="sm" className="w-100 w-sm-auto" onClick={() => handleEdit(razonSocial)}>Editar</Button>
              <Button variant="danger" size="sm" className="w-100 w-sm-auto" onClick={() => handleDelete(razonSocial._id!)}>Eliminar</Button>
            </div>
          )}
          className="small"
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} size="xl" centered>
        ...
        <Modal.Body className="px-4 py-3">
          <Form>
            <Row>
              ...
              <Col md={6} className="mb-3">
                ...
                <Form.Control 
                  ...
                  onChange={e => setNewRazonSocial({ ...newRazonSocial, rfc: e.target.value.toUpperCase() })} 
                />
              </Col>
            </Row>
            <Row>
              <Col md={4} className="mb-3">
                ...
                <Form.Control 
                  ...
                  onChange={e => setNewRazonSocial({ ...newRazonSocial, emailEmpresa: e.target.value })} 
                />
              </Col>
              <Col md={4} className="mb-3">
                ...
                <Form.Control 
                  ...
                  onChange={e => setNewRazonSocial({ ...newRazonSocial, telEmpresa: e.target.value })} 
                />
              </Col>
              <Col md={4} className="mb-3">
                ...
                <Form.Control 
                  ...
                  onChange={e => setNewRazonSocial({ ...newRazonSocial, celEmpresa: e.target.value })} 
                />
              </Col>
            </Row>
            <Row>
              <Col md={6} className="mb-3">
                ...
                <Form.Control 
                  ...
                  onChange={e => setNewRazonSocial({ ...newRazonSocial, direccionEmpresa: e.target.value })} 
                />
              </Col>
              <Col md={6} className="mb-3">
                ...
                <Form.Control 
                  ...
                  onChange={e => setNewRazonSocial({ ...newRazonSocial, emailFacturacion: e.target.value })} 
                />
              </Col>
            </Row>
                    ...
                    <Row>
                      <Col md={6} className="mb-2">
                        ...
                        <Form.Control 
                          ...
                          value={d.nombre} 
                          onChange={e => setNewRazonSocial({ 
                            ...newRazonSocial, 
                            direccionEnvio: newRazonSocial.direccionEnvio.map((x, i) => i === idx ? { ...x, nombre: e.target.value } : x) 
                          })} 
                        />
                      </Col>
                      <Col md={6} className="mb-2">
                        ...
                        <Form.Control 
                          ...
                          onChange={e => setNewRazonSocial({ 
                            ...newRazonSocial, 
                            direccionEnvio: newRazonSocial.direccionEnvio.map((x, i) => i === idx ? { ...x, telefono: e.target.value } : x) 
                          })} 
                        />
                      </Col>
                    </Row>
                    <Row>
                      <Col md={8} className="mb-2">
                        ...
                        <Form.Control 
                          ...
                          onChange={e => setNewRazonSocial({ 
                            ...newRazonSocial, 
                            direccionEnvio: newRazonSocial.direccionEnvio.map((x, i) => i === idx ? { ...x, direccion: e.target.value } : x) 
                          })} 
                        />
                      </Col>
                      <Col md={4} className="mb-2">
                        ...
                        <Form.Control 
                          ...
                          onChange={e => setNewRazonSocial({ 
                            ...newRazonSocial, 
                            direccionEnvio: newRazonSocial.direccionEnvio.map((x, i) => i === idx ? { ...x, contacto: e.target.value } : x) 
                          })} 
                        />
                      </Col>
                    </Row>
            ...
            <Button variant="outline-primary" size="sm" className="mt-2" onClick={handleAddDireccionEnvio}>
